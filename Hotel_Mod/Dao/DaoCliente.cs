...
namespace Hotel_Mod.Dao
{
    public class DaoCliente<T> : Dao<T>
    {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        obj.celular = Convert.ToString(reader["celular"]);  // Novo campo adicionado
        ...
        public override void Salvar(T obj)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string query = "INSERT INTO clientes (nome, apelido, data_nascimento, telefone, celular, cpf, email, rg, " +
                    "cep, logradouro, numero, bairro, complemento, cidade_id, ativo, data_cadastro, data_ult_alt) " +
                    "VALUES (@nome, @apelido, @data_nascimento, @telefone, @celular, @cpf, @email, @rg, @cep, @logradouro, " +
                ...
                command.Parameters.AddWithValue("@celular", cliente.celular);  // Novo campo adicionado
        ...
        public override void alterar(T obj)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string query = "UPDATE clientes SET nome = @nome, apelido = @apelido, data_nascimento = @data_nascimento, telefone = @telefone, " +
                    "celular = @celular, cpf = @cpf, email = @email, rg = @rg, cep = @cep, logradouro = @logradouro, " +
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataReader reader = command.ExecuteReader())
                {
                    if (reader.Read())
                    {
                        ...
                        obj.celular = reader["celular"].ToString();  // Novo campo adicionado
