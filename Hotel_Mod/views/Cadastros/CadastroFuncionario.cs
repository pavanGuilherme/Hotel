...
namespace Hotel_Mod.views.Cadastros
{
    public partial class CadastroFuncionario : Hotel_Mod.views.CadastroPai
    {
        ...
        public override void carrega()
        {
            ...
            if (altera != -1)
            {
                ...
                if (funcionario != null)
                {
                    ...
                    txt_sobrenome.Text = funcionario.sobrenome;
                    ...
                    txt_dat_cad.Text = funcionario.data_cadastro.ToString();
                    txt_dat_ult_alt.Text = funcionario.data_ult_alt.ToString();
                    check_ativo.Checked = funcionario.ativo;
                    check_inativo.Checked = !funcionario.ativo;

                    validadores.AtualizarCampoData(funcionario.data_nascimento, txt_data_nascimento);
                    validadores.AtualizarCampoData(funcionario.data_admissao, txt_data_admissao);
                    validadores.AtualizarCampoData(funcionario.data_demissao, txt_data_demissao);
        ...
        {
            if (validadores.VerificaLetras(txt_nome.Text))
            {
        ...
        {
            if (validadores.VerificaLetras(txt_sobrenome.Text))
            {
                MessageBox.Show("sobrenome inválido.", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txt_sobrenome.Focus();
            }
        }
